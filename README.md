...
-Data predictions - Obviously.ai
*Creative writing - ChatGPT
+Art & design - playgroundai
-Music - Avia
*Motion Capture - kinetix.tech
+Voice Cloning - UberDuck
-bravostudio app - create figma designs and turn to native app
...
- Go back to button **component** in glide, change the ***action*** from ***show notifications***(which is its default if triggered) to ***trigger webhook***
...
- Enter a random input (according to your prompt: create a shitpost about ```input```), click on the button
